...
(function(j) {
    ...
    e.prototype.initToolbar = function() {
        ...
        if (this.options.showSearch) {
            this.$toolbar.find('button[name="showSearch"]').off("click").on("click",
                function() {
        ...
        if (this.options.showColumns) {
            ...
            s.find("li").off("click").on("click",
                function(x) {
                    x.stopImmediatePropagation()
                });
            s.find("input").off("click").on("click",
                function() {
                    var x = j(this);
        ...
        if (this.options.search) {
            ...
            v.off("keyup drop").on("keyup drop",
                function(x) {
    ...
    e.prototype.initSearch = function() {
        ...
        if (this.options.sidePagination !== "server") {
            ...
            this.data = u ? j.grep(this.options.data,
                function(w, v) {
                    for (var s in u) {
    ...
    e.prototype.initServer = function(r, w, s) {
        ...
        t = j.extend({},
            q(null, this.options.ajaxOptions), {
    ...
    e.prototype.getSelections = function() {
        var r = this;
        return j.grep(this.options.data,
            function(s) {
    ...
    j.fn.bootstrapTable = function(s) {
        ...
        this.each(function() {
            var w = j(this),
                ...
                u = j.extend({},
                    e.DEFAULTS, w.data(), typeof s === "object" && s);
            if (typeof s === "string") {
                if (j.inArray(s, n) < 0) {
