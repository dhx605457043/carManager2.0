...
public interface ManagerSystemMenuMapper extends Mapper<ManagerSystemMenu>, BaseMapper<ManagerSystemMenu> {
     ...
     * @return 菜单信息
     */
    public ManagerSystemMenu selectMenuById(Long menuId);
     ...
     * @return 结果
     */
    public ManagerSystemMenu checkMenuNameUnique(@Param("menuName") String menuName, @Param("parentId") Long parentId);
