...
public class QiNiuCloudUtil {
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "xmk-ZCJLujdWHJacFVIGhi4pkU0dkkT3BnmxY09J";
    private static final String SECRET_KEY = "aZZCgOdgjlTu9ajEYM_NAtbOeU-7PPqGmtVBAyhc";

    // 要上传的空间
    private static final String bucketname = "car-manager-image";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

    private static final String DOMAIN = "img.wsb.huangxianzi.com";
